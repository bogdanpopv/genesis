...
export default async function ReportPage({ params }: { params: Params }) {
  ...
  const report = reports.data?.find((r) => r.id.toString() === id);
  ...
  return (
    <>
      <div className='bg-gradient-to-b from-white to-[#E1E5E9]'>
        <div className='m-auto flex max-w-[1080px] items-end gap-14 px-4 pt-12 pb-[120px] lg:pb-[174px] flex-wrap lg:flex-nowrap'>
          <div className='flex w-full flex-col gap-6 lg:w-1/2'>
            ...
            <h1 className='text-5xl md:text-[56px] font-bold leading-[56px] tracking-tighter'>{report.product_name}</h1>
          ...
          <div className='w-full lg:w-1/2'>
            <div className='flex w-full flex-col gap-6 rounded-3xl bg-[#1A2B3B] p-6'>
              <div className='flex gap-6 flex-wrap sm:flex-nowrap'>
                <div className='flex w-full sm:w-1/2 gap-2 rounded-xl bg-[#E4FF33] p-3'>
                  <div className='flex aspect-square h-full w-[58px] sm:w-[66px] items-center justify-center rounded-xl bg-[#C7E211]'>
                    <StarIcon className='h-6 w-6 text-[#132030]' />
                  </div>
                  <div>
                    <div className='font-alt text-base sm:text-xl'>Score:</div>
                    <div className='text-xl sm:text-3xl font-bold'>80</div>
                  </div>
                </div>
                <div className='flex w-full sm:w-1/2 gap-2 rounded-xl bg-[#31F2BF] p-3'>
                  <div className='flex aspect-square h-full w-[58px] sm:w-[66px] items-center justify-center rounded-xl bg-[#08DAA2]'>
                    <ChartBarIcon className='h-6 w-6 text-[#132030]' />
                  </div>
                  <div>
                    <div className='font-alt text-base sm:text-xl'>Difficulty:</div>
                    <div className='text-xl sm:text-3xl font-bold'>80</div>
                  </div>
                </div>
              </div>
              <div className='flex w-full gap-2 rounded-xl bg-[#34BCFF] p-3'>
                <div className='flex aspect-square h-full w-[58px] sm:w-[66px] items-center justify-center rounded-xl bg-[#2597E8]'>
                  <ChatBubbleLeftRightIcon className='h-6 w-6 text-white' />
                </div>
                <div className='text-white'>
                  <div className='font-alt text-base sm:text-xl'>Information From:</div>
                  <div className='text-xl sm:text-3xl font-bold'>r/Boardgames</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className='m-auto -mt-20 flex max-w-[1080px] px-4'>
        <div className='sticky top-10 mt-32 hidden md:flex h-max flex-col text-sm w-full max-w-[170px] shrink-0'>
        ...
        <div className='flex w-full max-w-[700px] shrink lg:shrink-0 flex-col rounded-3xl bg-white p-8 shadow-xl'>
          ...
          <div className='flex gap-8'>
            <div className='hidden sm:flex w-6 shrink-0 flex-col justify-between'>
        ...
        <div className='ml-6 bg-[#1A2B3B] p-3 hidden flex-col text-white gap-6 rounded-xl h-max sticky top-0 lg:flex'>
